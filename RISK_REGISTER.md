...
| EMU-R07 | High | Mitigated — EMU-B001 | Platform markers, Windows dependencies, immutable Action refs, and a fresh Windows 3.12 install/full suite passed. GitHub Actions runs `34011634890` and `34011648717` also passed Ubuntu core, Windows core, and browser smoke. | Preserve the platform matrix and require it to remain green for later changes. |
...
EMU-R09, EMU-R10, and EMU-R13 remain unresolved. Local implementation/testing may use synthetic fixtures without
